...
//  07 Nov 2016, JE
// Last Modified: 19 June 2017 add 2nd chip select to accomodate 2nd RHD2132 chip
...
const int CLK_DIV = 4;  // divisor for max transfer rate.  Setting SPI CLK = Max transfer rate, sometimes leads to convert errors. JE 20 Dec 2016
