...
//
// Last modified: JE 04 June 2019 adding SPI1 for amps C and D (128ch system)
//                JE 06 June 2019 filter settings same for all C and D, only use one function to do this
// -----------------------------------------------------------------------------


// Define function prototype to get user settings 
extern void configFilterSettings();
//extern void configFilterSettings_SPI1(); //added JE June 04 2019
