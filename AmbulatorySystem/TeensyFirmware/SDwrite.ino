...
///*
////--------------------------------------------
//// OUTDATED BLOCK OF CODE FOR SD CARD - DO NOT USE JE 16 Dec 2018
//// Open a file, prompt user to enter file name
////----------------------------------------
//boolean SDcardOpenFile() {
//
//
//  boolean SDcardOpenFile_success = false;
//  //int FILE_NAME_DIM = 12; // filename for file.createcontigous for SD must be DOS 8.3 format:
//  //  http://www.if.ufrj.br/~pef/producao_academica/artigos/audiotermometro/audiotermometro-I/bibliotecas/SdFat/Doc/html/class_sd_base_file.html#ad14a78d348219d6ce096582b6ed74526
//  //char fname[FILE_NAME_DIM];
//
//  const uint8_t BASE_NAME_SIZE = sizeof(FILE_BASE_NAME);
//  const uint8_t FILE_NAME_DIM  = BASE_NAME_SIZE + 6;
//  char binName[FILE_NAME_DIM] = FILE_BASE_NAME "00.tsy";
//  char fname[FILE_NAME_DIM];
//  strcpy(fname, binName);
//  //SERIALNAME->println("Input SD card filename extension:");
...
//    }
//
//    String incomingStr = SERIALNAME->readString();
//    incomingStr.toCharArray(fname, FILE_NAME_DIM);
//  */
//
//
//  serialFlush();
...
//
//
//  if (!dataFile.open(fname, O_WRITE | O_CREAT | O_TRUNC)) { //changed option to O_WRITE: Je 20 Nov 2018
//    SERIALNAME->println("Error encountered opening SD card data file");
//    //delay(1000);
//  }
//  else {
//    SERIALNAME->println("dataFile successfully opened!");
//    boolean SDcardOpenFile_success = true;
//  }
//
//  SERIALNAME->write(TERM_CHAR); // print termination character, to keep synced with LabView VISA R/W operations.
//
//  return SDcardOpenFile_success;
//
//}
